...
<template>
    <AdminLayout>
        ...
        <div class="flex items-center justify-between mb-8">
            <div>
                <h1 class="text-2xl font-bold text-neutral-900 dark:text-white">Sayfalar</h1>
                <p class="text-sm text-neutral-500 dark:text-neutral-400 mt-1">{{ pages.length }} sayfa</p>
            </div>
            <Link
        ...
        <div class="bg-white dark:bg-neutral-900 rounded-2xl border border-neutral-200 dark:border-neutral-800 overflow-hidden">
                ...
                <table class="w-full text-sm">
                    <thead>
                        <tr class="border-b border-neutral-200 dark:border-neutral-800 bg-neutral-50 dark:bg-neutral-950">
                            ...
                            <th class="text-left px-6 py-3 text-xs font-semibold text-neutral-500 dark:text-neutral-400 uppercase tracking-wider hidden md:table-cell">Slug</th>
                            <th class="text-left px-6 py-3 text-xs font-semibold text-neutral-500 dark:text-neutral-400 uppercase tracking-wider hidden lg:table-cell">Güncellendi</th>
                    ...
                    <tbody class="divide-y divide-neutral-100 dark:divide-neutral-800">
                        <tr v-for="page in pages" :key="page.id" class="hover:bg-neutral-50 dark:hover:bg-neutral-950 transition-colors">
                            <td class="px-6 py-4">
                                <p class="font-medium text-neutral-900 dark:text-white line-clamp-1">{{ page.title }}</p>
                            </td>
                            <td class="px-6 py-4 hidden md:table-cell">
                                <span class="text-xs font-mono text-neutral-400">/p/{{ page.slug }}</span>
                            </td>
            ...
            <div v-if="!pages.length" class="px-6 py-12 text-center text-sm text-neutral-400">
